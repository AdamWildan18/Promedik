            ...
            <div class="col-xxl-4 col-xl-5 col-lg-6 col-md-7 col-sm-8">
                <div class="card shadow-lg">
                    <div class="card-body p-4">
                        <h1 class="fs-4 text-center fw-bold mb-4">Create Customer</h1>
                        <form method="POST" action="{{ route('add.customer') }}" class="cretaebranch" autocomplete="off">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-join mb-3">
                                    <input id="code_customer" type="text" placeholder="Enter code_customer" class="form-control"
                                        name="code_customer" value="" required autofocus>
                                        <span class="input-group-text rounded-end"></span>
                                    <div class="invalid-feedback">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-join mb-3">
                                    <input id="address" type="text" placeholder="Enter address" class="form-control"
                                        name="address" value="" required autofocus>
                                        <span class="input-group-text rounded-end"></span>
                                    <div class="invalid-feedback">
                                        Address is invalid
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-join mb-3">
                                    <select name="specialist" id="" class="form-select rounded-end">
                                        <option value="">Choice Specialist</option>
                                        <option value="Orthopedi">Orthopedi</option>
                                        <option value="BedahSyaraf">BedahSyaraf</option>
                                        <option value="BedahUmum">BedahUmum</option>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-join mb-3">
                                    <input id="hari" type="text" placeholder="Enter Hari" class="form-control"
                                        name="hari" value="" required autofocus>
                                        <span class="input-group-text rounded-end"></span>
                                    <div class="invalid-feedback">
                                        Hari is invalid
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-join mb-3">
                                    <input id="jam" type="text" placeholder="Enter Jam cth: 17:00 - 18:00" class="form-control"
                                        name="jam" value="" required autofocus>
                                        <span class="input-group-text rounded-end"></span>
                                    <div class="invalid-feedback">
                                        Jam is invalid
                                    </div>
