            ...
            <div class="col-xxl-4 col-xl-5 col-lg-6 col-md-7 col-sm-8">
                <div class="card shadow-lg">
                    <div class="card-body p-4">
                        <h1 class="fs-4 text-center fw-bold mb-4">Edit Product</h1>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-join mb-3">
                                    <input id="code_product" type="text" placeholder="Enter code_product" class="form-control"
                                        name="code_product" value="{{ $data->code_product }}" required autofocus>
                                        <span class="input-group-text rounded-end"></span>
                                    <div class="invalid-feedback">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-join mb-3">
                                    <input id="price" type="number" placeholder="Enter price" class="form-control"
                                        name="price" value="{{ $data->price }}" required autofocus>
                                        <span class="input-group-text rounded-end"></span>
                                    <div class="invalid-feedback">
                                        Price is invalid
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-join mb-3">
                                    <input id="stock" type="number" placeholder="Enter stock" class="form-control"
                                        name="stock" value="{{ $data->stock }}" required autofocus>
                                        <span class="input-group-text rounded-end"></span>
                                    <div class="invalid-feedback">
                                        Stock is invalid
                                    </div>
