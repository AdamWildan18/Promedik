            ...
            <div class="col-xxl-4 col-xl-5 col-lg-6 col-md-7 col-sm-8">
                <div class="card shadow-lg">
                    <div class="card-body p-4">
                        <h1 class="fs-4 text-center fw-bold mb-4">Edit Area</h1>
                        <form method="POST" action="{{ route('update.area', ['id' => $data->id]) }}" class="editarea" autocomplete="off">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-join mb-3">
                                    <input id="code_area" type="text" placeholder="Enter code_area" class="form-control"
                                        name="code_area" value="{{ $data->code_area }}" required autofocus>
                                        <span class="input-group-text rounded-end"></span>
                                    <div class="invalid-feedback">
...
<script>
    $(document).on('submit', '.editarea', function (event) {
